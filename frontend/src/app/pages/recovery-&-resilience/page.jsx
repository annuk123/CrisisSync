...
// //import disasterImage from '../assets/disaster-image.jpg'; // Assuming you have an image file in your assets folder

// const images = [
//        'https://imgs.search.brave.com/FfIDej40M9Q9ZQxytqiKUjVsCv7p3gkwTyT-x2yb7po/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/cHJlbWl1bS1waG90/by9uYXR1cmFsLWRp/c2FzdGVyXzExMzQ5/MDEtMzMyOTcwLmpw/Zz9zaXplPTYyNiZl/eHQ9anBn',
//     ];
...
//         <img src={images} alt="Disaster Recovery" className="rounded-lg shadow-lg mb-6" />
//       </div>
//       <h1 className="text-3xl font-custom text-center text-gray-900">
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-200 p-6">
      ...
      <div className="max-w-3xl mx-auto mb-6">
        <img src={images[0]} alt="Disaster Recovery" className="rounded-lg shadow-lg w-full h-auto" />
      </div>
